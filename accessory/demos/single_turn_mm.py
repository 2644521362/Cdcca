...
ans = generate('/data/lcx/someResource/man.jpeg','What is in the photo?',"","alpaca",128,0.1,.75)
print(ans)
...
#     ]
#     print('got input : ',prompt,question_input,system_prompt,max_gen_len,gen_t,top_p)
#     outputs = [text_output]
